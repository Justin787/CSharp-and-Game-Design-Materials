...
namespace Text_Adventure_2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Strength:" + StrengthV);
            Console.WriteLine("Endurance:" + EnduranceV);
            Console.WriteLine("Knowledge:" + KnowledgeV);
            Console.WriteLine("Senses:" + SensesV);
            Console.WriteLine("Money:" + MoneyV + "\n");

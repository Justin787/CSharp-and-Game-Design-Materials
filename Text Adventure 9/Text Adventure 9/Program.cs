...
*/
namespace Text_Adventure_9
{
    class Program
    {
		//Global variables
		static string Gnome_ASCII = "                        ^                          \n" +
								 "                       / \\                        \n" +
								 "       The            /   \\                       \n" +
								 "     Forest...       /_____\\                      \n" +
								 "                    /VVVVVVv\\                     \n" +
		...
		static int StrengthV = 9;
		static int EnduranceV = 4;
		static int KnowledgeV = 5;
		static int HP = 100;//Player health
		static double MoneyV = 0.00;
		static string Stats = " Strength:" + StrengthV +
					   "\n Endurance:" + EnduranceV +
					   "\n Knowledge:" + KnowledgeV +
					   "\n Health:" + HP +
					   "\n Money:" + MoneyV + "\n";

		static int row = 0, col = 0; //keep track of current player location
		static string[,] locations = { { "Plane Wreckage", "Pond" }, { "West Entrance", "East Entrance" } };
		static string[,] descriptions = new string[2, 2];
		static string[,] maps = new string[2, 2];
		static string command = "";//keep track of user input
		static string name = "";
			...
			while (command != "quit")
			{
				...
				if (command.Contains(" "))
				{
					...
					else //bad verb
					{
						...
						Console.WriteLine(" I'm telling the teacher that you said the " + verb.Substring(0, 1).ToUpper() + "-word!");
